...
//? 기능
// - 가속하다: '현재 속도 증가' / 정지하다: '차량을 정지' / 경적을 울리다: '경적 울림'
...
// >> 함수 내부에서 this 키워들르 사용하여 객체의 속성(프로퍼티) 정의
...
let person1 = new Human('박지성', 175);
let person2 = new Human('손흥민', 183);

console.log(person1.name);
console.log(person1.height);
person1.greet(); // Hello, 박지성

console.log(person2.name);
console.log(person2.height);
person2.greet(); // Hello, 손흥민
