...
// cf) 화살표 함수 적용
const newArrowNums = numbers.map(value => {}); 
// 중괄호(구현부) 생략 시 return 키워드로 생략
...
// > 어떤 메서드(기능)이 반환하는 값을 기반으로 또 다른 매서드를 줄줄이 사용하는 것
